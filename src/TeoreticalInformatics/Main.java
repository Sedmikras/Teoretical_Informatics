...
public class Main {
      ...
      public static void main(String[] args) {
            ...
            System.out.print("### Vytvořil David Bohmann & Přemysl Kouba jako semestrální práci pro předmět Teoretická Informatika na ZČU v akademickém roce 2016/17 ###\n"
                    + "                ### Pro nápovědu napište h či help do konzole a potvrďte klávesou ENTER###\n"
                    + "                    ## Pro vystoupení z počátečního stavu S0 zmáčkněte klávesu ENTER##\n\n\n");
            State s = States.Init;
            String word;
            ...
            while (true) {
                  ...
                  if (word.isEmpty() || word.charAt(0) == Utilities.BLANK) {
                        ...
                        if (word.charAt(0) == 'h') {
                              ...
                              if (word.charAt(0) == Utilities.BUTTON_0 || word.charAt(0) == Utilities.BUTTON_1 || word.charAt(0) == Utilities.BUTTON_2) {
      ...
      private static String showHelp() {
            System.out.println("Tématem semestrální práce je řízení složité silniční křižovatky. Programem je zpracována křižovatka U Prazdroje - Lobezská - Šumavská v Plzni\n"
                    + "Program se ovládá klávesnicí skrz konzoli. "
                    + "Každou volbu potvrďte stisknutím klávesy ENTER.\n\n"

                    + "Ze základu jsou klávesové zkratky tyto :(nejsou case-sensitive)\n"
                    + "q(Q).... ukončí program\n"
                    + "h(H).... vypíše nápovědu\n"
                    + "a(A).... tlačítko 1 (lze přepsat v souboru Utilities.java)\n"
                    + "b(B).... tlačítko 2 (lze přepsat v souboru Utilities.java)\n"
                    + "c(C).... tlačítko 3 (lze přepsat v souboru Utilities.java)\n"
                    + " (mezerník).... pokud chceme pokročit o stav dále, stiskneme klávesu ENTER, nebo mezerník a klávesu ENTER. Tato zkratka nahrazuje časovač a jeho obsluhu\n");
